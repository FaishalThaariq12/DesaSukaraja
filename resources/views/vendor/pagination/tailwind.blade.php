...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
    <style>
        .pagination-soft .bg-white,
        .pagination-soft .dark\:bg-gray-800 {
            background-color: #f8fafc !important;
        }

        .pagination-soft .border-gray-300,
        .pagination-soft .dark\:border-gray-600 {
            border-color: #e2e8f0 !important;
        }

        .pagination-soft .text-gray-700,
        .pagination-soft .text-gray-500,
        .pagination-soft .dark\:text-gray-300,
        .pagination-soft .dark\:text-gray-400 {
            color: #334155 !important;
        }

        .pagination-soft .hover\:text-gray-500:hover {
            color: #059669 !important;
        }

        .pagination-soft .active {
